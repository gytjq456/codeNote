...
<!-- #include virtual="/inc/header.asp" -->
	...
	<div class="privacy">
		<p>ㅇㅇㅇㅇ (이하 '회사')는 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다. 회사는 개인정보취급방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.</p>
			...
			<dt>개인정보 제공</dt>
				<dd>회사는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.
					<ul>
						...
						<li>- 제품 배송 또는 설치 및 A/S에 필요로 하는 경우 (이름, 휴대전화번호, 설치지역 주</li>
					</ul>
				</dd>	
		</dl>
		<dl>
