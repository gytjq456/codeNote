...
<table class="ntb-tb-view quick_start" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<input type="text" name="txtCaptcha" id="txtCaptcha" value="" class="AXInput vmiddle" style="width:118px" maxlength="5" autocomplete="off" placeholder="코드를 입력하세요" autocomplete="off" /><br /></td>
	</tr>
	<%End If%>
