...
<table class="ntb-tb-view" cellpadding="0" cellspacing="0">
	...
	<tr>
		<th>링크URL</th>
		<td class="left"><input type="text"  name="mem_url" size="35" maxlength="50" value="<%=c_mem_url%>" class="AXInput" /></td>
	</tr>
	<%End If%>
	...
	<tr>
		<th>등록일 수정</th>
		<td class="left"><input type="text" id="regdate" name="regdate" size="16" maxlength="16" value="<%=FormatDateTime(c_regdate, 2) & " " & FormatDateTime(c_regdate, 4)%>" class="AXInput" /> 예) 2019-07-01 01:14</td>
	</tr>
	<%End If%>
