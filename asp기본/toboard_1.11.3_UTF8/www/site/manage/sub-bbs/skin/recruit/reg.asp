	...
	<div class="tb_info">
		...
		<table>
			...
			<tr>
				...
				<td class="bdt bdr"><input type="text"  name="mem_url" value="<%=c_mem_url%>" class="AXInput" style="width:80%;" /></td>
			</tr>
			<%End If%>
			...
			<tr>
				<th class="title bdr bdt">지원기간</th>
				<td class="bdt bdr">
				<input type="text" name="addtext1" id="addtext1" maxlength="10" value="<%=c_addtext1%>" class="AXInput W100" autocomplete="off" maxlength="10" required /> ~
				<input type="text" name="addtext2" id="addtext2" maxlength="10" value="<%=c_addtext2%>" class="AXInput W100" autocomplete="off" maxlength="10" required />
				</td>
			</tr>
