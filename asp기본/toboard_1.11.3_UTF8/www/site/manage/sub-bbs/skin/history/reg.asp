	...
	<div class="tb_info">
		...
		<table>
			...
			<tr>
				...
				<td class="bdt bdr"><input type="text"  name="mem_url" size="35" maxlength="50" value="<%=c_mem_url%>" class="AXInput" /></td>
			</tr>
			<%End If%>
			...
			<tr>
				<th class="title bdr bdt">년도</th>
				<td class="bdt bdr"><input type="text"  name="addtext1" value="<%=TagText(c_addtext1)%>" class="AXInput W60" maxlength="4" required numberOnly />년</td>
			</tr>
			<tr>
				<th class="title bdr bdt">월</th>
				<td class="bdt bdr"><input type="text"  name="addtext2" value="<%=TagText(c_addtext2)%>" class="AXInput W40" maxlength="2" required numberOnly />월</td>
			</tr>
			<tr style="display:none">
				<th class="title bdr bdt">제목</th>
				<td class="bdt bdr"><input type="text"  name="title" value="-" class="AXInput width:100%" required /></td>
			</tr>
			...
			<tr>
				...
				<td class="bdt bdr">
				<textarea cols="" rows="" name="content" id="content" style="width:100%; height:60px"><%=c_content%></textarea></td>
			</tr>

			<!-- 파일첨부 -->
			<%For fc=0 To k_upload-1%>
			<tr>
				<th class="title bdr bdt">파일첨부<%=fc+1%></th>
				<td class="bdt bdr">
				<%If mode="mod" Then
					if c_file(fc)="" Then%>
						현재 등록된 파일이 없습니다.<br />
			...
			<tr>
				...
				<input type="text" name="txtCaptcha" id="txtCaptcha" value="" class="AXInput vmiddle" style="width:118px" maxlength="5" autocomplete="off" required /><br /></td>
			</tr>
			<%End If%>
