...
<form name="regform" action="?<%=pLink%>&amp;mode=<%=mode%>_p&amp;idx=<%=idx%>&amp;page=<%=page%>&amp;p_num=<%=p_num%>" method="post" enctype="multipart/form-data" onsubmit="return RegChk(this)">
	...
	<div class="tb_info">
		...
		<table>
			...
			<tr>
				<th class="title bdr bdt">Youtube 소스</th>
				<td class="bdt bdr">https://youtu.be/<input type="text"  name="addtext1" maxlength="11"value="<%=c_addtext1%>" class="AXInput W100" /><br />
				<span class="txt_small">
				- Youtube 영상의 고유코드 11자리를 입력하세요.<br />
				&nbsp;&nbsp;e.q1) https://www.youtube.com/watch?v=<span style="font-weight:bold; color:#f88">9SmQOZWNyWE</span><br />
				&nbsp;&nbsp;e.q2) https://youtu.be/<span style="font-weight:bold; color:#f88">9SmQOZWNyWE</span></span></td>
			</tr>
