			...
			If Rs.EOF=False Then
				...
				Do Until Rs.EOF Or cnt>=Rs.pagesize
					...
					<tr>
						...
						<td class="bdr bdt">
						<%If b_addtext1<>"" Then%>
							<img src="http://i.ytimg.com/vi/<%=b_addtext1%>/mqdefault.jpg" alt="thumb<%=b_idx%>" style="width:110px; height:75px" />
						<%Else%>
							<img src="http://placehold.it/75X75/?text=No image" alt="<%=b_idx%>" class="gallery-image" />
						<%End If%></td>
