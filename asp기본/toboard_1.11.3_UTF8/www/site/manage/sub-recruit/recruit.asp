	...
	<div class="tb_list">
		...
		<table>
			...
			<%
				...
				SQL = "SELECT * FROM tbl_recruit WHERE idx != '' AND edate >= '"&Date()&"' AND state <> '2' "
			...
			<tr>
				...
				<td class="bdr bdt tit"><% If r_top = 1 Then %>[<font color="red">★</font>]<% End if %>&nbsp;<%=com_NM%></td>
