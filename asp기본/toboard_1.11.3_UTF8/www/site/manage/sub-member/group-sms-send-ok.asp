...
sms_content = InsertText(Request("sms_content"))
...
Call SendSMS(s_fromnum, s_tonum, sms_content, "전송 완료 되었습니다.", "http://" & Request.ServerVariables("SERVER_NAME") & "/site/manage/sub-member/group-sms-send.asp")
%>