...
Function PageList(url, page, pagesize, cutpage, totalrecord)
	...
	Response.Write "<div class=""paging"">" & Chr(10) & Chr(13)
	Response.Write "	<div class=""arr"">" & Chr(10) & Chr(13)

	If page =< cutpage Then
		startpage = 1
		Response.Write "		<a href=""#;""><i class=""xi-angle-left-min""></i></a>" & Chr(10) & Chr(13)
	Else
		...
		End If
		Response.Write "		<a href=""" & url & "&amp;page=1"" class=""first""><i class=""xi-angle-left-min""></i><i class=""xi-angle-left-min""></i></a>" & Chr(10) & Chr(13)
		Response.Write "		<a href=""" & url & "&amp;page=" & startpage-cutpage & """ class=""first""><i class=""xi-angle-left-min""></i></a>" & Chr(10) & Chr(13)
	End If

	Response.Write "	</div>" & Chr(10) & Chr(13)
	Response.Write "	<ul>" & Chr(10) & Chr(13)
	...
	Do While endpage <> countpage And countpage < maxpage
		...
		If countpage=page Then
			Response.Write "		<li class='on'><a href='#;'>" & countpage & "</a></li> " & Chr(10) & Chr(13)
		Else
			Response.Write "		<li><a href='" & url & "&amp;page=" & countpage & "'>" & countpage & "</a></li> " & Chr(10) & Chr(13)
		End If
	Loop
	Response.Write "	</ul>" & Chr(10) & Chr(13)
	...
	If countpage < maxpage Then
		Response.Write "		<a href=""" & url & "&amp;page=" & startpage+cutpage & """><i class=""xi-angle-right-min""></i></a></li>" & Chr(10) & Chr(13)
		Response.Write "		<a href=""" & url & "&amp;page=" & maxpage & """ class=""last""><i class=""xi-angle-right-min""></i><i class=""xi-angle-right-min""></i></a>" & Chr(10) & Chr(13)
	Else
		Response.Write "		<a href=""#;""><i class=""xi-angle-right-min""></i></a>" & Chr(10) & Chr(13)
	End If
